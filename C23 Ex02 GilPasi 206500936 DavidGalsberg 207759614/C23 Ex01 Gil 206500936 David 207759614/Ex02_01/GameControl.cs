...
public class GameControl
{
    ...
    private char[] m_correctSequence;
    internal const int k_GuessSize = 4;
    ...
    public GameControl(uint i_MaxGuessesCount)
    {
        ...
        m_correctSequence = generateSequence();
    }
    ...
    public static bool CheckIfPragmaticallyValidSequence(char[] i_Sequence)
    {
        ...
        {
            for (int j = i; j < i_Sequence.Length; j++)
            {
    ...
    {
        m_turnsHistory.Add(new Turn(i_Guess));
    }
